parameters= [
  { name = "dev.frontend.catalogue_url", value= "http://catalogue-dev.devops-practice.tech:8080/", type= "String"},
  { name = "dev.frontend.user_url", value= "http://user-dev.devops-practice.tech:8080/", type= "String"},
  ...
  { name = "dev.cart.redis_host", value= "redis-dev.devops-practice.tech", type= "String"},
  { name = "dev.cart.catalogue_host", value= "catalogue-dev.devops-practice.tech", type= "String"},
  { name = "dev.cart.catalogue_port", value= "8080", type= "String"},
  { name = "dev.catalogue.mongo", value= "true", type= "String"},
  { name = "dev.catalogue.mongo_url", value= "mongodb://mongodb-dev.devops-practice.tech:27017/catalogue", type= "String"},
  { name = "dev.payment.cart_url", value="cart-dev.devops-practice.tech", type= "String"},
  { name = "dev.payment.cart_port", value= "8080", type= "String"},
  { name = "dev.payment.user_host", value= "user-dev.devops-practice.tech", type= "String"},
  { name = "dev.payment.user_port", value= "8080", type= "String"},
  { name = "dev.payment.amqp_host", value= "rabbitmq-dev.devops-practice.tech", type= "String"},
  { name = "dev.shipping.cart_endpoint", value= "cart-dev.devops-practice.tech:8080", type= "String"},
  { name = "dev.shipping.db_host", value= "mysql-dev.devops-practice.tech", type= "String"},
  { name = "dev.user.mongo", value= "true", type= "String"},
  { name = "dev.user.redis_host", value= "redis-dev.devops-practice.tech", type= "String"},
